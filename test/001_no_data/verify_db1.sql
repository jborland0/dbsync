...
--
-- Host: 127.0.0.1    Database: djangoledger_test_1
-- ------------------------------------------------------
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`djangoledger`@`%`*/ /*!50003 TRIGGER `trigger_insert_ledger_banknamelookup` AFTER INSERT ON `ledger_banknamelookup` FOR EACH ROW BEGIN INSERT INTO sync_ledger_banknamelookup (pkl_id,created,modified,deleted) VALUES (NEW.id,localtimestamp,localtimestamp,0); END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`djangoledger`@`%`*/ /*!50003 TRIGGER `trigger_update_ledger_banknamelookup` AFTER UPDATE ON `ledger_banknamelookup` FOR EACH ROW BEGIN UPDATE sync_ledger_banknamelookup SET modified = localtimestamp WHERE pkl_id = NEW.id; END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`djangoledger`@`%`*/ /*!50003 TRIGGER `trigger_delete_ledger_banknamelookup` AFTER DELETE ON `ledger_banknamelookup` FOR EACH ROW BEGIN UPDATE sync_ledger_banknamelookup SET modified = localtimestamp, deleted = 1 WHERE pkl_id = OLD.id; END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`djangoledger`@`%`*/ /*!50003 TRIGGER `trigger_insert_ledger_category` AFTER INSERT ON `ledger_category` FOR EACH ROW BEGIN INSERT INTO sync_ledger_category (pkl_id,created,modified,deleted) VALUES (NEW.id,localtimestamp,localtimestamp,0); END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`djangoledger`@`%`*/ /*!50003 TRIGGER `trigger_update_ledger_category` AFTER UPDATE ON `ledger_category` FOR EACH ROW BEGIN UPDATE sync_ledger_category SET modified = localtimestamp WHERE pkl_id = NEW.id; END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`djangoledger`@`%`*/ /*!50003 TRIGGER `trigger_delete_ledger_category` AFTER DELETE ON `ledger_category` FOR EACH ROW BEGIN UPDATE sync_ledger_category SET modified = localtimestamp, deleted = 1 WHERE pkl_id = OLD.id; END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`djangoledger`@`%`*/ /*!50003 TRIGGER `trigger_insert_ledger_entity` AFTER INSERT ON `ledger_entity` FOR EACH ROW BEGIN INSERT INTO sync_ledger_entity (pkl_id,created,modified,deleted) VALUES (NEW.id,localtimestamp,localtimestamp,0); END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`djangoledger`@`%`*/ /*!50003 TRIGGER `trigger_update_ledger_entity` AFTER UPDATE ON `ledger_entity` FOR EACH ROW BEGIN UPDATE sync_ledger_entity SET modified = localtimestamp WHERE pkl_id = NEW.id; END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`djangoledger`@`%`*/ /*!50003 TRIGGER `trigger_delete_ledger_entity` AFTER DELETE ON `ledger_entity` FOR EACH ROW BEGIN UPDATE sync_ledger_entity SET modified = localtimestamp, deleted = 1 WHERE pkl_id = OLD.id; END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`djangoledger`@`%`*/ /*!50003 TRIGGER `trigger_insert_ledger_ledger` AFTER INSERT ON `ledger_ledger` FOR EACH ROW BEGIN INSERT INTO sync_ledger_ledger (pkl_id,created,modified,deleted) VALUES (NEW.id,localtimestamp,localtimestamp,0); END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`djangoledger`@`%`*/ /*!50003 TRIGGER `trigger_update_ledger_ledger` AFTER UPDATE ON `ledger_ledger` FOR EACH ROW BEGIN UPDATE sync_ledger_ledger SET modified = localtimestamp WHERE pkl_id = NEW.id; END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`djangoledger`@`%`*/ /*!50003 TRIGGER `trigger_delete_ledger_ledger` AFTER DELETE ON `ledger_ledger` FOR EACH ROW BEGIN UPDATE sync_ledger_ledger SET modified = localtimestamp, deleted = 1 WHERE pkl_id = OLD.id; END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`djangoledger`@`%`*/ /*!50003 TRIGGER `trigger_insert_ledger_settings` AFTER INSERT ON `ledger_settings` FOR EACH ROW BEGIN INSERT INTO sync_ledger_settings (pkl_id,created,modified,deleted) VALUES (NEW.id,localtimestamp,localtimestamp,0); END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`djangoledger`@`%`*/ /*!50003 TRIGGER `trigger_update_ledger_settings` AFTER UPDATE ON `ledger_settings` FOR EACH ROW BEGIN UPDATE sync_ledger_settings SET modified = localtimestamp WHERE pkl_id = NEW.id; END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`djangoledger`@`%`*/ /*!50003 TRIGGER `trigger_delete_ledger_settings` AFTER DELETE ON `ledger_settings` FOR EACH ROW BEGIN UPDATE sync_ledger_settings SET modified = localtimestamp, deleted = 1 WHERE pkl_id = OLD.id; END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`djangoledger`@`%`*/ /*!50003 TRIGGER `trigger_insert_ledger_transactiontype` AFTER INSERT ON `ledger_transactiontype` FOR EACH ROW BEGIN INSERT INTO sync_ledger_transactiontype (pkl_id,created,modified,deleted) VALUES (NEW.id,localtimestamp,localtimestamp,0); END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`djangoledger`@`%`*/ /*!50003 TRIGGER `trigger_update_ledger_transactiontype` AFTER UPDATE ON `ledger_transactiontype` FOR EACH ROW BEGIN UPDATE sync_ledger_transactiontype SET modified = localtimestamp WHERE pkl_id = NEW.id; END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`djangoledger`@`%`*/ /*!50003 TRIGGER `trigger_delete_ledger_transactiontype` AFTER DELETE ON `ledger_transactiontype` FOR EACH ROW BEGIN UPDATE sync_ledger_transactiontype SET modified = localtimestamp, deleted = 1 WHERE pkl_id = OLD.id; END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
